...
const designForPostit: StarterSkill = {
  title: "Design for Post-it",
  summary:
    "For Claude Design: specify HTML mockups with data-pi-* attributes, publish them to a Post-it flow, and work through review comments.",
  body: `---
