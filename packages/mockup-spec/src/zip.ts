 ...
 *
 * A handover is a handful of HTML files and two text files, so compression buys
 * little and a dependency buys less. What matters is that any unzip tool opens
 * it, which the stored method guarantees.
 */
